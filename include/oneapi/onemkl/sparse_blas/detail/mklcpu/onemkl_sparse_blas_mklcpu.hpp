...
#include "oneapi/onemkl/detail/export.hpp"
#include "oneapi/onemkl/sparse_blas/detail/helper_types.hpp"

namespace oneapi::mkl::sparse::mklcpu {

namespace detail = oneapi::mkl::sparse::detail;

#include "oneapi/onemkl/sparse_blas/detail/onemkl_sparse_blas_backends.hxx"
