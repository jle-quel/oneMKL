...
.. code-block:: bash
    ...
    python scripts/generate_backend_api.py include/oneapi/onemkl/blas.hpp \                                  # Base header file
                                           include/oneapi/onemkl/blas/detail/newlib/onemkl_blas_newlib.hpp \ # Output header file
                                           oneapi::mkl::newlib                                            # Wrappers namespace

Code snippet of the generated header file ``include/oneapi/onemkl/blas/detail/newlib/onemkl_blas_newlib.hpp``
...
.. code-block:: bash
    ...
    python scripts/generate_ct_instant.py   include/oneapi/onemkl/blas/detail/blas_ct_templates.hpp \         # Base header file
                                            include/oneapi/onemkl/blas/detail/newlib/blas_ct.hpp \            # Output header file
                                            include/oneapi/onemkl/blas/detail/newlib/onemkl_blas_newlib.hpp \ # Header file with declaration of entry points to wrappers
                                            newlib \                                                       # Library name
                                            newdevice \                                                    # Backend name
                                            oneapi::mkl::newlib                                            # Wrappers namespace

Code snippet of the generated header file ``include/oneapi/onemkl/blas/detail/newlib/blas_ct.hpp``
...
* ``include/oneapi/onemkl/detail/backends.hpp``: add the new backend
...
* ``include/oneapi/onemkl/detail/backends_table.hpp``: add new backend library for supported domain(s) and device(s)
...
* ``include/oneapi/onemkl/detail/get_device_id.hpp``: add new device detection mechanism for Run-time dispatching
...
* ``include/oneapi/onemkl/blas.hpp``: include the generated header file for the compile-time dispatching interface (see `oneMKL Usage Models <../README.md#supported-usage-models>`_)

  **Example**: add ``include/oneapi/onemkl/blas/detail/newlib/blas_ct.hpp`` generated at the `1. Create Header Files`_ step
    
  .. code-block:: diff
    
        #include "oneapi/onemkl/blas/detail/mklcpu/blas_ct.hpp"
        #include "oneapi/onemkl/blas/detail/mklgpu/blas_ct.hpp"
     +  #include "oneapi/onemkl/blas/detail/newlib/blas_ct.hpp"
...
* ``src/blas/backends/newlib/newlib_wrappers.cpp`` - DPC++ wrappers for all functions from ``include/oneapi/onemkl/blas/detail/newlib/onemkl_blas_newlib.hpp``
...
.. code-block:: bash
    ...
    python scripts/generate_wrappers.py include/oneapi/onemkl/blas/detail/newlib/onemkl_blas_newlib.hpp \ # Base header file
...
.. code-block:: diff
        ...
        #include "oneapi/onemkl/blas/detail/newlib/onemkl_blas_newlib.hpp"
    +    
    +    #include "newlib.h"
